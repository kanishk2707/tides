...
import com.mythron.aethertides.client.EntityRenderer
...
import com.mythron.aethertides.client.ShipRenderer
...
import com.mythron.aethertides.client.net.RoundResult
import com.mythron.aethertides.client.net.Session
import com.mythron.aethertides.client.roleName
import com.mythron.aethertides.client.ui.NavigatorHud
import com.mythron.aethertides.client.ui.TempestHud
import com.mythron.aethertides.shared.math.MathX
import com.mythron.aethertides.shared.net.EventRec
import com.mythron.aethertides.shared.sim.Config
import com.mythron.aethertides.shared.sim.EndReason
import com.mythron.aethertides.shared.sim.EventKind
...
class PlayScreen(
    ...
    private fun drawStats(g: com.mythron.aethertides.client.Painter, sw: Float, sh: Float) {
     ...
     */
    private fun drawResultCard(g: com.mythron.aethertides.client.Painter, sw: Float, sh: Float) {
    ...
    private fun rematch() {
        when (val s = session) {
            ...
            is OnlineSession -> {
                s.sendCommand(com.mythron.aethertides.shared.sim.Command.REMATCH, 0, 0f, 0f)
                s.clearResult()
                resultShown = false
                resultAlpha = 0f
                fx.clear()
